  ...
  <div class="analytics">
    ...
    <el-row :gutter="20" class="overview-stats">
      ...
      <el-col :xs="12" :sm="6">
        <el-card class="stat-card" shadow="never">
          <div class="stat-item">
            ...
            <div class="stat-change" :class="getChangeClass(stats.executions_change)">
              <el-icon><TrendCharts /></el-icon>
              {{ formatChange(stats.executions_change) }}
            </div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="12" :sm="6">
        <el-card class="stat-card" shadow="never">
          <div class="stat-item success">
            ...
            <div class="stat-change" :class="getChangeClass(stats.success_rate_change)">
              <el-icon><TrendCharts /></el-icon>
              {{ formatChange(stats.success_rate_change) }}%
            </div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="12" :sm="6">
        <el-card class="stat-card" shadow="never">
          <div class="stat-item warning">
            <div class="stat-number">{{ formatDuration(stats.avg_duration) }}</div>
            <div class="stat-label">平均耗时</div>
            <div class="stat-change" :class="getChangeClass(stats.duration_change)">
              <el-icon><TrendCharts /></el-icon>
              {{ formatChange(stats.duration_change) }}s
            </div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="12" :sm="6">
        <el-card class="stat-card" shadow="never">
          <div class="stat-item info">
            ...
            <div class="stat-change" :class="getChangeClass(stats.tokens_change)">
              <el-icon><TrendCharts /></el-icon>
              {{ formatChange(stats.tokens_change) }}
            </div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="12" :sm="6">
        <el-card class="stat-card" shadow="never">
          <div class="stat-item">
            ...
            <div class="stat-change" :class="getChangeClass(stats.files_change)">
              <el-icon><TrendCharts /></el-icon>
              {{ formatChange(stats.files_change) }}
            </div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="12" :sm="6">
        <el-card class="stat-card" shadow="never">
          <div class="stat-item">
            ...
            <div class="stat-change" :class="getChangeClass(stats.active_tasks_change)">
              <el-icon><TrendCharts /></el-icon>
              {{ formatChange(stats.active_tasks_change) }}
            </div>
          </div>
        </el-card>
      </el-col>
      ...
      <el-col :xs="12" :sm="6">
        <el-card class="stat-card" shadow="never">
          <div class="stat-item">
            <div class="stat-number">{{ formatFileSize(stats.avg_file_size) }}</div>
            <div class="stat-label">平均文件大小</div>
            <div class="stat-change" :class="getChangeClass(stats.file_size_change)">
              <el-icon><TrendCharts /></el-icon>
              {{ formatChange(stats.file_size_change) }}
            </div>
          </div>
        </el-card>
      </el-col>
