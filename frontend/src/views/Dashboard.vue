        ...
        <el-card class="detail-card">
          ...
          <div class="metric-list">
            <div class="metric-item">
              ...
              <span class="metric-value">{{ formatExecutionTime(stats?.avg_execution_time) }}</span>
            </div>
            <div class="metric-item">
              <span class="metric-label">Token总消耗</span>
              <span class="metric-value">{{ formatNumber(stats?.total_token_usage) }}</span>
            </div>
            <div class="metric-item">
      ...
      <div v-else class="activity-list">
        ...
        >
          <div class="activity-icon">
            <el-icon 
              :class="getExecutionStatusClass(execution.execution_status)"
            >
              <component :is="getExecutionStatusIcon(execution.execution_status)" />
            </el-icon>
          </div>
          <div class="activity-content">
            <div class="activity-title">
              任务 "{{ execution.task?.name }}" {{ getExecutionStatusText(execution.execution_status) }}
            </div>
